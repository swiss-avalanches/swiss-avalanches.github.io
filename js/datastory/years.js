...
document.getElementById('dot-danger-2').innerHTML = '<svg height="12" width="12"><circle r=5 fill="#ffff00" transform="translate(6,6)"/></svg>'
document.getElementById('dot-danger-3').innerHTML = '<svg height="12" width="12"><circle r=5 fill="#ff9900" transform="translate(6,6)"/></svg>'
